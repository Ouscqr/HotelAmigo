export const en = {
  ...
  hero: {
    ...
    title: "Your Amsterdam Adventure Awaits",
    description: "Your comfortable Amsterdam getaway! Welcoming rooms with lovely city views and easy access to all the charm this wonderful city offers.",
  ...
  home: {
    welcome: {
      subtitle: "Welcome to Hotel Amigo",
      title: "Your Friendly Amsterdam Base",
      description1: "Located on lively Linnaeusstraat, Hotel Amigo offers comfortable private and shared rooms with free Wi-Fi, perfect for travelers looking to experience authentic Amsterdam. With excellent tram connections just steps away, you're perfectly positioned to explore the city's famous attractions.",
      description2: "Our bright rooms feature hardwood floors, large windows, and all the essentials for a comfortable stay. Just a short tram ride from Rembrandt Square and Leidseplein, and within walking distance of Oosterpark, Hotel Amigo provides affordable comfort in a fantastic location for your Amsterdam adventure.",
      learnMore: "Discover Amsterdam"
    },
    booking: {
