...
// import { Sparkles, Dumbbell, Droplets, Heart, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen } from "lucide-react";
...
//     const icons = {
//       wellness: [<Sparkles key={0} />, <Dumbbell key={1} />, <Droplets key={2} />, <Heart key={3} />],
