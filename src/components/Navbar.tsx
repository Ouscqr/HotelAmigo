...
export default function Navbar() {
  ...
  return (
    <header className={cn(
      ...
      scrolled 
        ? "bg-white dark:bg-card border-b border-gray-200 dark:border-gray-700 py-3 shadow-md" 
        : "bg-transparent py-5"
    )}>
              ...
              <ul className="space-y-6">
                {navLinks.map(link => (
                  <li key={link.name}>
                    <Link 
                      to={link.path} 
                      className="text-lg font-medium text-gray-900 dark:text-white transition-colors hover:text-primary" 
